...
class VideoCamera(object):
    def __init__(self):
        ...
        pygame.mixer.init()
        sound_file = 'beep.wav'  # Specify the path to your sound file
        ...
        if ret:
            try:
                ...
                for i in indexes.flatten():
                    ...
                    # Display the name of the place on the detection box
                    place_name = record()  # Get the name of the place from the record() function
                    cv2.putText(frame, place_name, (x, y + 35), font, .5, (255, 255, 255), 1)
